      ...
      <div className="container flex flex-d-responsive">
        ...
        <div className="container_item">
          <form action="" className="flex flex-d-col">
            <input id="name-field" className="field form_item w-100 fade-in-down" type="text" placeholder="Name" required />
            <input id="email-field" className="field form_item w-100 fade-in-down" type="email" placeholder="Email" required />
            <textarea id="msg-field" className="field form_item w-100 fade-in-down" placeholder="Message" cols="30" rows="6"></textarea>
            <input className="btn-contained form_item w-100 fade-in-down" type="submit" value="Submit Message" />
          </form>
        </div>
      </div>
    </section>
